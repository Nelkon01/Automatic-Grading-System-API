...
class Grader:
    ...
    def run(self, id) -> Tuple[Tuple[Submission], int]:
        io_choices = {}
        try:
            ...
            tasks = map(Runner(self, asyncio.Lock(), self.testcase_picker, id), self.submissions)
...
class Runner:
    ...
    def __init__(self, grader: Grader, lock: asyncio.Lock, testcase_picker: TestCasePicker, id) -> None:
        self.grader = grader
        self.lock = lock
